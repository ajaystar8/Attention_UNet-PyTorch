...
parser = argparse.ArgumentParser(description='Script to segment an image using a trained checkpoint of Attention-UNet.',
...
model_path = os.path.join(args.checkpoint_dir, "attention_unet_pure_noisy_mix.pth")
